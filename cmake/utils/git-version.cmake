...
function( doVersionCheck )
  ...
  # default returns
  set( PROJECT_VERSION_MAJOR "X" PARENT_SCOPE )
  set( PROJECT_VERSION_MINOR "X" PARENT_SCOPE )
  set( PROJECT_VERSION_MICRO "X" PARENT_SCOPE )
  set( PROJECT_VERSION_TAG "" PARENT_SCOPE )
  set( PROJECT_VERSION_POST_NB "" PARENT_SCOPE )
  set( PROJECT_VERSION_POST_COMMIT "" PARENT_SCOPE )
  set( PROJECT_VERSION_STRING "X.X.X" PARENT_SCOPE )
  set( PROJECT_VERSION_BRANCH "" PARENT_SCOPE )
  ...
  if(RETURN_VAL EQUAL "0")
    ...
    if( ${len} GREATER_EQUAL 2 )
      ...
      #    set(PROJECT_VERSION_TAG "-${VERSION_POST_NB}-${VERSION_POST_COMMIT}")
      set( PROJECT_VERSION_TAG "f" )
      set( PROJECT_VERSION_POST_NB "${VERSION_POST_NB}" PARENT_SCOPE )
      set( PROJECT_VERSION_POST_COMMIT "${VERSION_POST_COMMIT}" PARENT_SCOPE )
      ...
      if(RETURN_VAL EQUAL "0")
        set( PROJECT_VERSION_BRANCH "${CURRENT_BRANCH_NAME}" PARENT_SCOPE )
    ...
    set( PROJECT_VERSION_MICRO "${VERSION_MICRO}" PARENT_SCOPE )

    # Building the version string
    set( PROJECT_VERSION_STRING
        "${VERSION_MAJOR}.${VERSION_MINOR}.${VERSION_MICRO}${PROJECT_VERSION_TAG}"
        PARENT_SCOPE
    )
